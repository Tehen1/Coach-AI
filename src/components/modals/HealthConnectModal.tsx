            ...
            <CardContent className="space-y-4">
                <Card className="bg-black/20 border-white/20">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <Button onClick={() => handleConnect('Apple Health')}>Connecter</Button>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-black/20 border-white/20">
                     <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <Button onClick={() => handleConnect('Google Fit')}>Connecter</Button>
                    </CardHeader>
                    <CardContent>
                        <p className="text-xs text-white/60">Importez vos activités, données de fitness et objectifs.</p>
                    </CardContent>
                </Card>
